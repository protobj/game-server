...
//
//public class LettuceRedisPoolDataSource implements RedisDataSource {
//    private GenericObjectPool<RedisConn> connectionPool;
//
//    public class RedisConn implements AutoCloseable {
//        final RedisReactiveCommands<byte[], byte[]> connection;
//
//        public RedisConn(RedisReactiveCommands<byte[], byte[]> connection) {
//            this.connection = connection;
//        }
//
//        public RedisReactiveCommands<byte[], byte[]> getConnection() {
//            return connection;
//        }
//
//        @Override
...
//                StatefulRedisConnection<byte[], byte[]> redisConnection = redisClient.connect(
