...
//    stop.asMono()
//        .then(doStop())
//        .doFinally(s -> onStop.emitEmpty(RetryNonSerializedEmitFailureHandler.RETRY_NON_SERIALIZED))
//        .subscribe(
...
//    return Mono.defer(
//        () -> {
//          stop.emitEmpty(RetryNonSerializedEmitFailureHandler.RETRY_NON_SERIALIZED);
...
//        sink.emitNext(message, RetryNonSerializedEmitFailureHandler.RETRY_NON_SERIALIZED);
//      } catch (Exception e) {
