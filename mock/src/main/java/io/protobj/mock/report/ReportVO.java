package io.protobj.mock.report;
...
public class ReportVO {
    ...
    public String toCsv() {
        ...
        for (ReportCmdVO value : getReportCmdList()) {
            Map<Integer, String> rqstDescMap = new HashMap<>();
            content.append(value.getCmd()).append(",").append(rqstDescMap.get(value.getCmd())).append(",").append(value.getRqstCount())//
